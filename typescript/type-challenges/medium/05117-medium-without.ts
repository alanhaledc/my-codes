...
type Includes<T extends unknown[], U extends unknown> = T extends [
  infer F,
  ...infer R
]
  ? F extends U
...
> = T extends [infer F, ...infer R]
  ? Includes<U, F> extends true
    ? WithoutMulti<R, U, Arr>
    : WithoutMulti<R, U, [...Arr, F]>
  : Arr;

type Without<
  T extends unknown[],
  U extends unknown | unknown[]
> = U extends unknown[] ? WithoutMulti<T, U> : WithoutMulti<T, [U]>;
