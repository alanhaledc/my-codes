...
type Prop<P> = PropType<P> | { type?: PropType<P> };
type PropType<P> = PropConstructor<P> | PropConstructor<P>[];
...
type InferProps<P extends Record<string, unknown>> = {
  [K in keyof P]: InferPropType<P[K]>;
};
type InferComputed<C extends Record<string, () => unknown>> = {
