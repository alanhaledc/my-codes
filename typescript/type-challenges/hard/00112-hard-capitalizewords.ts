...
> = S extends `${infer First}${infer Rest}`
  ? T extends `${string}${Letters}`
    ? CapitalizeWords<Rest, `${T}${First}`>
    : CapitalizeWords<Rest, `${T}${Capitalize<First>}`>
  : T;
...
type c = CapitalizeWords<"aa!bb@cc#dd$ee%ff^gg&hh*ii(jj)kk_ll+mm{nn}oo|pp🤣qq">;
