...
type GetUnionLast<U> = UnionToIntersectionFn<U> extends () => infer R
  ? R
  : never;

type UnionToTuple<U, Arr extends unknown[] = [], Last = GetUnionLast<U>> = [
  U
] extends [never]
  ? Arr
  : UnionToTuple<Exclude<U, Last>, [Last, ...Arr]>;

/* _____________ Test Cases _____________ */

import type { Equal, Expect } from "@type-challenges/utils";

type ExtractValuesOfTuple<U extends any[]> = U[keyof U & number];
